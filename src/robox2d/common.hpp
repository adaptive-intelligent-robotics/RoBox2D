...
namespace robox2d {
  namespace common {
    ...
    b2Fixture* addBoxFixture(b2Body* body, const b2Vec2& halfSize, const b2Vec3& transformation, const float density, const float friction = 0.8f, const float restitution = 0.f);
    b2Fixture* addCircleFixture(b2Body* body, const float radius, const b2Vec3& transformation, const float density, const float friction = 0.8f, const float restitution = 0.f);
