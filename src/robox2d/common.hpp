...
namespace robox2d {
  namespace common {
    ...
    b2Body* createCircle( std::shared_ptr<b2World> world, const float radius, const b2BodyType type, const b2Vec3& transformation, const float density = 1.0f, const float friction = 0.8f, const float restitution = 0.0f);
