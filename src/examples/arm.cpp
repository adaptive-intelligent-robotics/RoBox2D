...
public:
  ...
  Arm(std::shared_ptr<b2World> world){
    ...
    b2Body* body = robox2d::common::createBody( world,{arm_length*0.025f, arm_length*0.025f}, b2_staticBody,  {0.0f,0.0f,0.0f} );
    ...
    for(size_t i =0; i < nb_joints; i++)
      {
	_end_effector = robox2d::common::createBody( world,{seg_length*0.5f , arm_length*0.01f }, b2_dynamicBody, {(0.5f+i)*seg_length,0.0f,0.0f} );
